...
// iterate albums
            ;(function () {
                ...
                if ('number' == typeof $$obj.length) {
                    for (var pug_index0 = 0, $$l = $$obj.length; pug_index0 < $$l; pug_index0++) {
                        ...
                        ;pug_debug_line = 13;
                        pug_debug_filename = 'views\u002F\u002Falbum_page.pug';
                        pug_html = pug_html + '\u003Cdiv class="card-body p-0 mt-2"\u003E';
                        ;pug_debug_line = 14;
                        pug_debug_filename = 'views\u002F\u002Falbum_page.pug';
                        pug_html = pug_html + '\u003Ca' + (' class="card-text mt-1 text-white noselect album_text"' + pug_attr('href', url, true, false)) + '\u003E';
                        ;pug_debug_line = 14;
                        pug_debug_filename = 'views\u002F\u002Falbum_page.pug';
                        pug_html = pug_html + (pug_escape(null == (pug_interp = album.title) ? '' : pug_interp)) + '\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E';
                    }
                }
                else {
                    var $$l = 0;
        ...
        }.call(this, 'albums' in locals_for_with ? locals_for_with.albums : typeof albums !== 'undefined' ? albums : undefined));
    } catch (err) {
