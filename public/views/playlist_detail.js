...
pug_html = pug_html + "\u003Ca class=\"playlist_cover_image\"\u003E";
...
pug_html = pug_html + "\u003Ca" + (" class=\"dropdown-item delete_playlist_in_detail_page\""+pug_attr("href", delete_playlist_id, true, false)+" id=\"DelPlaylist\"") + "\u003E";
;pug_debug_line = 40;pug_debug_filename = "views\u002Fplaylist_detail.pug";
pug_html = pug_html + "Delete Playlist\u003C\u002Fa\u003E";
}
else {
;pug_debug_line = 42;pug_debug_filename = "views\u002Fplaylist_detail.pug";
pug_html = pug_html + "\u003C!--a.dropdown-item(id='AcceptShare', href=accept_url) Accept Share--\u003E";
;pug_debug_line = 43;pug_debug_filename = "views\u002Fplaylist_detail.pug";
pug_html = pug_html + "\u003Ca" + (" class=\"dropdown-item\""+" id=\"RejectShare\""+pug_attr("href", reject_url, true, false)) + "\u003E";
;pug_debug_line = 43;pug_debug_filename = "views\u002Fplaylist_detail.pug";
...
pug_html = pug_html + "\u003C!-- - console.log(track);--\u003E";
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";}.call(this,"playlist" in locals_for_with?locals_for_with.playlist:typeof playlist!=="undefined"?playlist:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}