...
pug_html = pug_html + "\u003Ci class=\"fas fa-search tool-bar-icon mr-3\" id=\"track_search\"\u003E\u003C\u002Fi\u003E\u003C\u002Fdiv\u003E";
;pug_debug_line = 8;pug_debug_filename = "views\u002F\u002Ftrack_page_delete_status_tool_bar.pug";
pug_html = pug_html + "\u003Cdiv class=\"d-flex track_page_search_area align-items-center hidden\"\u003E";
;pug_debug_line = 9;pug_debug_filename = "views\u002F\u002Ftrack_page_delete_status_tool_bar.pug";
pug_html = pug_html + "\u003Cinput class=\"w-100\" id=\"track_search_input\" type=\"text\" placeholder=\"Search Tracks...\"\u002F\u003E";
;pug_debug_line = 10;pug_debug_filename = "views\u002F\u002Ftrack_page_delete_status_tool_bar.pug";
pug_html = pug_html + "\u003Ci class=\"fas fa-times\" id=\"track_search_close\"\u003E\u003C\u002Fi\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}